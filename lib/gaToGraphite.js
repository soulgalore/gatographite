		...
		jwtClient.authorize(function(err, tokens) {
			if (err) {
				...
				analytics.data.ga.get({
						...
						console.log('Got ' + response.rows.length + ' results, configured max result is ' + conf.maxResults);
						...
						sender.send(result, function() {console.log('Finished sending the metrics to Graphite');});
					}
